...
)
{
    ...
    function softsdev_product_shippings_settings() {
        ...
        <div class="left-mc-setting">
            ...
            <p>This version is limited in features. For a small fee you can get the Premium version with <a href="http://www.dreamfoxmedia.com/shop/woocommerce-shipping-gateway-per-product-premium/#utm_source=wp-plugin&utm_medium=wcsgpp&utm_campaign=portfolio">More Settings</a>!</p>
        ...
        <div class="right-mc-setting">
            <div style="border: 5px dashed #B0E0E6; padding: 0 20px; background: white;">
                ...
                <p>This plugin has a Premium version with more settings. <a href="http://www.dreamfoxmedia.com/shop/woocommerce-shipping-gateway-per-product-premium/#utm_source=wp-plugin&utm_medium=wcsgpp&utm_campaign=portfolio">Have a look at its benefits</a>!</p>
            </div>
