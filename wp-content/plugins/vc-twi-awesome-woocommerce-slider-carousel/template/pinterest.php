...
?>
<ul id = "twi-woo-style-<?php echo $twi_i; ?>" class="twi-grid twi-woo-style products twi-pinterest woocommerce <?php if($twi_full=='yes'){ echo 'twi-forced-fullwidth';}else{ echo 'undefine'; } ?> twi-grid-width-xlarge-1-<?php echo $xlarge; ?> twi-grid-width-large-1-<?php echo $large; ?> twi-grid-width-medium-1-<?php echo $medium; ?> twi-grid-width-small-1-<?php echo $small; ?> twi-grid-width-1-<?php echo $default; ?> twi-grid-<?php echo $gap; ?><?php if(($car_pagi == 'yes' && $pagi_type == 'more') || ($car_pagi == 'yes' && $pagi_type == 'infinite')){ ?> twi-load-more<?php } ?>"<?php if(($car_pagi == 'yes' && $pagi_type == 'more') || ($car_pagi == 'yes' && $pagi_type == 'infinite')){ ?> data-method="<?php echo $pagi_type; ?>" data-pagi-type="<?php echo $pagi_type; ?>" data-load-txt="<?php echo $load_txt; ?>" data-load-img="<?php echo $up_loader; ?>" data-done-txt="<?php echo $done_txt; ?>"<?php } ?>" data-twi-grid="{gutter:<?php if( $gutter == 0 ) {echo 1;}else{echo $gutter; } ?>,animation:false}">
	<?php
