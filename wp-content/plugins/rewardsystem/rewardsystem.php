<?php
/*
 * Plugin Name: SUMO Reward Points-Null24.Net
 * Plugin URI:
...
//        include_once 'inc/admin/class_gift_voucher_tab.php';
        ...
        include_once 'inc/admin/class_new_gift_voucher.php';
        ...
        include('inc/rs_function_for_new_gift_voucher.php');
        ...
        include('inc/rs_function_for_troubleshoot_tab.php');
        ...
        include 'inc/admin/class_wp_list_table_for_newgift_voucher.php';
                                ...
                                if ($emails->rsmailsendingoptions == '3') {
                                    ...
                                    if (get_option('rscheckcronsafter') > 1) {
                                        ...
                                        foreach (get_users() as $myuser) {
                                            ...
                                            $coupon_value_in_points = RSFunctionForCart::get_woocommerce_formatted_price(round($coupon_value_in_points, $roundofftype));
    ...
    public static function rs_check_if_woocommerce_is_active() {
        ...
        if (is_multisite()) {
            if (!is_plugin_active_for_network('woocommerce/woocommerce.php') && (!is_plugin_active('woocommerce/woocommerce.php'))) {
                if (is_admin()) {
                    $variable = "<div class='error'><p> Nu.l.l.2.4.N.e.T-SUMO Reward Points will not work until WooCommerce Plugin is Activated. Please Activate the WooCommerce Plugin. </p></div>";
                    echo $variable;
                }
                return;
            }
...
//Email Template Table
        ...
        $email_temp_check = $wpdb->get_results("SELECT * FROM $table_name_email ", OBJECT);
        if(!isset($email_temp_check[0]->rs_status)){
