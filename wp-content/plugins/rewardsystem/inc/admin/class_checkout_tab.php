    ...
    public static function reward_system_admin_fields() {
        ...
        if (!is_wp_error($particularcategory)) {
         ...
         return apply_filters('woocommerce_rewardsystem_checkout_settings', array(
            ...
            array(
                'name' => __('Enable Selected Products for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'),
                'desc' => __('Enable Products Purchase for Selceted Products Using Sumo Reward Points Gateway', 'rewardsystem'),
                'tip' => '',
            ...
            array(
                'name' => __('Select Products for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'),
                'desc' => __('Select Products for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'),
                'tip' => '',
              ...
              array(
                'name' => __('Enable Selected Categories for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'),
                'desc' => __('Enable Products Purchase for Selceted Categories Using Sumo Reward Points Gateway', 'rewardsystem'),
                'tip' => '',
             ...
             array(
                'name' => __('Select Categories for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'),
                'desc' => __('Select Categories for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'),
                'tip' => '',
