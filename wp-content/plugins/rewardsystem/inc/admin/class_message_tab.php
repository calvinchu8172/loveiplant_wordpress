    ...
    public static function reward_system_admin_fields() {
        ...
        return apply_filters('woocommerce_rewardsystem_message_settings', array(
            ...
            array(
              ...
              array(
                'name' => __('Show/Hide Notice for Hide the coupon field and SUMO Reward Redeem field If  Point Price Product in Cart ', 'rewardsystem'),
                'desc' => '',
            ...
            array(
                'name' => __('Message Displayed for Hide the coupon field and SUMO Reward Redeem field If  Point Price Product in Cart', 'rewardsystem'),
