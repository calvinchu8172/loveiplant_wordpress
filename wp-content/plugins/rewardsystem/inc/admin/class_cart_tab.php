...
class RSCart {
    ...
    public static function reward_system_admin_fields() {
        ...
        return apply_filters('woocommerce_rewardsystem_cart_settings', array(
            ...
            array(
                'name' => __('Minimum Cart Total for Earn Points', 'rewardsystem'),
             ...
             array(
                'name' => __('Minimum Cart Total to Earn Points Error Message Show/Hide', 'rewardsystem'),
                'desc' => '',
            ...
            array(
                'name' => __('Minimum Cart Total for Earn Points Error Message', 'rewardsystem'),
             ...
             array(
                'name' => __('Maximum Cart Total to Earn Points', 'rewardsystem'),
              ...
              array(
                'name' => __('Maximum Cart Total to Earn Points Error Message Show/Hide', 'rewardsystem'),
                'desc' => '',
            ...
            array(
                'name' => __('Maximum Cart Total to Earn Points Error Message', 'rewardsystem'),
            ...
            array(
             ...
             array(
                'name' => __('Maximum Cart Total for Redeeming', 'rewardsystem'),
            ...
            array(
                'name' => __('Maximum Cart Total for Redeeming Error Message Show/Hide', 'rewardsystem'),
                'desc' => '',
            ...
            array(
                'name' => __('Maximum Cart Total for Redeeming Error Message', 'rewardsystem'),
