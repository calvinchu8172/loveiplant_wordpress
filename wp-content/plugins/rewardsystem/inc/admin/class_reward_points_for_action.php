    ...
    public static function reward_system_admin_fields() {
         ...
         return apply_filters('woocommerce_rewardsystem_reward_points_for_action_settings', array(
            ...
            array(
             ...
             array(
              ...
              array(
                ...
                'options' => array(
                    ...
                    '2' => __('Minimum Number of Successful Orders', 'rewardsystem'),
                    '3' => __('Minimum Amount Spent by the User', 'rewardsystem'),
                ),
                'desc_tip' => true,
            ),
              array(
                'name' => __('Enter Number of Successful Orders ', 'rewardsystem'),
             ...
             array(
                'name' => __('Enter Minimum Amount Spent by User', 'rewardsystem'),
