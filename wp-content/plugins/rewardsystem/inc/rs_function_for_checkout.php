...
class RSFunctionForCheckout {
    ...
    public function __construct() {
        ...
        add_action('woocommerce_before_checkout_form', array($this, 'display_redeem_min_max_points_buttons_on_cart_page'));
        ...
        if ((float) $woocommerce->version > (float) ('2.2.0')) {
            ...
            <tr valign="top">
                <th class="titledesc" scope="row">
                    <label for="rs_select_product_for_purchase_using_points"><?php _e('Select Products for Purchase Using Sumo Reward Points Gateway', 'rewardsystem'); ?></label>
                </th>
            ...
            if ($_GET['tab'] == 'rewardsystem_checkout') {
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function () {
                        ...
                        var enable_selected_product_for_purchase1 = jQuery('#rs_enable_selected_category_for_purchase_using_points').is(':checked') ? 'yes' : 'no';
            ...
            if ($minimum_cart_total_redeem != '' && $maximum_cart_total_redeem != '') {
                if ($current_carttotal_amount >= $minimum_cart_total_redeem && $current_carttotal_amount <= $maximum_cart_total_redeem) {
                    ...
                    if (get_option('rs_show_hide_maximum_cart_total_error_message') == '1') {
                        ...
                        $max_cart_total_currency_to_replace = RSFunctionForCart::get_woocommerce_formatted_price($max_cart_amount_to_replace);
                ...
                if ($current_carttotal_amount >= $minimum_cart_total_redeem) {
                    ...
                    if (get_option('rs_show_hide_minimum_cart_total_error_message') == '1') {
                        ...
                        $min_cart_total_currency_to_replace = RSFunctionForCart::get_woocommerce_formatted_price($min_cart_amount_to_replace);
