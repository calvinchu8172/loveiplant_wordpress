...
class RSFunctionForOrder {
    ...
    public function __construct() {
        ...
        add_filter('woocommerce_get_order_item_totals', array($this, 'display_message_total_earn_point_for_order'), 8, 2);
    }

    public static function display_message_total_earn_point_for_order($total_rows, $orderid) {
