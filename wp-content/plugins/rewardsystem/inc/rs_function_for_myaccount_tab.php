...
//            add_action('wp_head', array($this, 'ajax_for_saving_nominee'));
        ...
        if (get_option('rs_display_generate_referral') == '2') {
            if (get_option('rs_show_hide_generate_referral') == '1') {
                ...
                if (get_option('rs_show_hide_generate_referral_link_type') == '1') {
                    ...
                    add_action('woocommerce_after_my_account', array($this, 'generate_referral_key'));

                    add_action('woocommerce_after_my_account', array($this, 'list_table_array'));
                } else {
                    add_action('woocommerce_after_my_account', array($this, 'function_to_display_static_url'));
                }
            }
        }
        ...
        add_shortcode('rs_user_total_points_in_value', array($this, 'add_shortcode_to_display_user_total_points_in_value'));
    }
    ...
    public static function add_shortcode_to_display_user_total_points_in_value() {
        ...
        return round($getoldpoints, $roundofftype) . '(' . RSFunctionForCart::get_woocommerce_formatted_price(round($coupon_value_in_points, $roundofftype)) . ')';
    }
...
jQuery(".my_account_referral_link").load(window.location + " .my_account_referral_link");
                        ...
                        <tr class="referrals" data-url="<?php echo $mainkey[0]; ?>">
                            ...
                            <td>
                                <div class="rs_social_buttons">
                                    <div class="fb-share-button" data-href="<?php echo $mainkey[0]; ?>" data-type="button"></div><br><br>
    ...
    public static function view_list_table_in_myaccount() {
        ...
        if ($display_currency == '1') {
            ...
            $coupon_value_in_points = $revised_amount / $point_control;           
            $msg = '(' . RSFunctionForCart::get_woocommerce_formatted_price(round($coupon_value_in_points, $roundofftype)) . ')';
        } else {
            $msg = '';
        }
