...
function wc_memberships_get_members_area_sections( $membership_plan = '' ) {
	...
	return apply_filters( 'wc_membership_plan_members_area_sections', array(
		'my-membership-content'   => __( 'My Content', WC_Memberships::TEXT_DOMAIN ),
		'my-membership-products'  => __( 'My Products', WC_Memberships::TEXT_DOMAIN ),
		'my-membership-discounts' => __( 'My Discounts', WC_Memberships::TEXT_DOMAIN ),
		'my-membership-notes'     => __( 'Membership Notes', WC_Memberships::TEXT_DOMAIN ),
	), $membership_plan );
}
