...
abstract class RP_WCDPD_Condition_Field_Multiselect extends RP_WCDPD_Condition_Field
{
    ...
    {
        RP_WCDPD_Form::multiselect($this->get_field_attributes($context));
    }
    ...
    {
        return $this->load_multiselect_options($value);
    }
    ...
    {
        return 'rp_wcdpd_' . $context . '_condition_' . $this->key . ' rp_wcdpd_child_element_field rp_wcdpd_select2';
    }
