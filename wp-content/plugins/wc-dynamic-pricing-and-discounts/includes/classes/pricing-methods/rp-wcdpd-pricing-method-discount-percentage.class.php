...
class RP_WCDPD_Pricing_Method_Discount_Percentage extends RP_WCDPD_Pricing_Method_Discount
{
    ...
    protected $contexts = array('product_pricing_simple', 'product_pricing_quantity', 'product_pricing_bogo', 'product_pricing_group', 'cart_discounts_simple');
     ...
     * @return float
     */
    public function calculate($setting, $reference_amount = 0)
    {
