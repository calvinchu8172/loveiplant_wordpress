...
<div id="rp_wcdpd_templates" style="display: none;">
        ...
        <div class="rp_wcdpd_row">
            ...
            <div class="rp_wcdpd_row_content">
                ...
                <?php if ($current_tab === 'product_pricing'): ?>
                    ...
                    <div class="rp_wcdpd_row_content_product_pricing_row rp_wcdpd_row_content_product_pricing_bogo_row rp_wcdpd_if rp_wcdpd_if_bogo rp_wcdpd_if_bogo_repeat" style="display: none;">
                        <div class="rp_wcdpd_field rp_wcdpd_field_full">
                            <label><?php _e('Buy X Get Y', 'rp_wcdpd'); ?></label>
                            <div class="rp_wcdpd_inner_wrapper">
                                ...
                                <div class="rp_wcdpd_field rp_wcdpd_field_single">
                                    <?php RP_WCDPD_Form::number(array(
                                        ...
                                        'placeholder'               => '0',
                                        'label'                     => __('Receive', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => RP_WCDPD_Settings::get('decimal_quantities') ? 'required,number_natural' : 'required,number_min_1,number_whole',
                                    )); ?>
                                </div>

                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_receive_products">
                                    <?php RP_WCDPD_Form::grouped_select(array(
                                        'id'                        => 'rp_wcdpd_' . $current_tab . '_bogo_receive_products_{i}',
                                        'name'                      => 'rp_wcdpd_settings[' . $current_tab . '][{i}][bogo_receive_products]',
                                        'class'                     => 'rp_wcdpd_' . $current_tab . '_field_bogo_receive_products',
                                        'options'                   => RP_WCDPD_Settings::get_receive_products_methods_for_display(),
                                        'label'                     => __('Receive Products', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    ), false); ?>
                                </div>

                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_pricing rp_wcdpd_no_left_margin">
                                    <?php RP_WCDPD_Form::grouped_select(array(
                                        ...
                                        'label'                     => RP_WCDPD_Pricing::get_pricing_settings_label($current_tab),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    ), true); ?>
                                </div>
                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_pricing">
                                ...
                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_items rp_wcdpd_field_bogo_items_product__product" style="display: none;">
                                    <?php RP_WCDPD_Form::multiselect(array(
                                        'id'                        => 'rp_wcdpd_' . $current_tab . '_bogo_products_{i}',
                                        'name'                      => 'rp_wcdpd_settings[' . $current_tab . '][{i}][bogo_products][]',
                                        'class'                     => 'rp_wcdpd_' . $current_tab . '_field_bogo_products rp_wcdpd_select2',
                                        'options'                   => array(),
                                        'label'                     => __('Products', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    )); ?>
                                </div>
                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_items rp_wcdpd_field_bogo_items_product__variation" style="display: none;">
                                    <?php RP_WCDPD_Form::multiselect(array(
                                        'id'                        => 'rp_wcdpd_' . $current_tab . '_bogo_product_variations_{i}',
                                        'name'                      => 'rp_wcdpd_settings[' . $current_tab . '][{i}][bogo_product_variations][]',
                                        'class'                     => 'rp_wcdpd_' . $current_tab . '_field_bogo_product_variations rp_wcdpd_select2',
                                        'options'                   => array(),
                                        'label'                     => __('Product Variations', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    )); ?>
                                </div>
                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_items rp_wcdpd_field_bogo_items_product__category" style="display: none;">
                                    <?php RP_WCDPD_Form::multiselect(array(
                                        'id'                        => 'rp_wcdpd_' . $current_tab . '_bogo_product_categories_{i}',
                                        'name'                      => 'rp_wcdpd_settings[' . $current_tab . '][{i}][bogo_product_categories][]',
                                        'class'                     => 'rp_wcdpd_' . $current_tab . '_field_bogo_product_categories rp_wcdpd_select2',
                                        'options'                   => array(),
                                        'label'                     => __('Product Categories', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    )); ?>
                                </div>
                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_items rp_wcdpd_field_bogo_items_product__attributes" style="display: none;">
                                    <?php RP_WCDPD_Form::multiselect(array(
                                        'id'                        => 'rp_wcdpd_' . $current_tab . '_bogo_product_attributes_{i}',
                                        'name'                      => 'rp_wcdpd_settings[' . $current_tab . '][{i}][bogo_product_attributes][]',
                                        'class'                     => 'rp_wcdpd_' . $current_tab . '_field_bogo_product_attributes rp_wcdpd_select2',
                                        'options'                   => array(),
                                        'label'                     => __('Product Attributes', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    )); ?>
                                </div>
                                <div class="rp_wcdpd_field rp_wcdpd_field_double rp_wcdpd_field_bogo_items rp_wcdpd_field_bogo_items_product__tags" style="display: none;">
                                    <?php RP_WCDPD_Form::multiselect(array(
                                        'id'                        => 'rp_wcdpd_' . $current_tab . '_bogo_product_tags_{i}',
                                        'name'                      => 'rp_wcdpd_settings[' . $current_tab . '][{i}][bogo_product_tags][]',
                                        'class'                     => 'rp_wcdpd_' . $current_tab . '_field_bogo_product_tags rp_wcdpd_select2',
                                        'options'                   => array(),
                                        'label'                     => __('Product Tags', 'rp_wcdpd'),
                                        'disabled'                  => 'disabled',
                                        'data-rp-wcdpd-validation'  => 'required',
                                    )); ?>
                                </div>
                    ...
                    <div class="rp_wcdpd_row_content_product_pricing_row rp_wcdpd_row_content_product_pricing_group_row rp_wcdpd_row_content_child_row rp_wcdpd_row_content_group_products_row rp_wcdpd_if rp_wcdpd_if_group rp_wcdpd_if_group_repeat" style="display: none;">
                        <div class="rp_wcdpd_field rp_wcdpd_field_full">
                            <label><?php _e('Products In Group', 'rp_wcdpd'); ?></label>
                            <div class="rp_wcdpd_inner_wrapper">
                ...
                <div class="rp_wcdpd_row_content_child_row rp_wcdpd_row_content_conditions_row">
                    <div class="rp_wcdpd_field rp_wcdpd_field_full">
                        <?php if ($current_tab === 'product_pricing'): ?>
                            <label class="rp_wcdpd_if rp_wcdpd_if_simple rp_wcdpd_if_bulk rp_wcdpd_if_tiered rp_wcdpd_if_bogo rp_wcdpd_if_bogo_repeat rp_wcdpd_if_exclude" style="display: none;"><?php _e('Products & Conditions', 'rp_wcdpd'); ?></label>
                        <?php endif; ?>
                        <label class="rp_wcdpd_if rp_wcdpd_if_group rp_wcdpd_if_group_repeat"><?php _e('Conditions', 'rp_wcdpd'); ?></label>
                        <div class="rp_wcdpd_inner_wrapper">
    ...
    <div id="rp_wcdpd_no_conditions_template">
        <div class="rp_wcdpd_no_conditions rp_wcdpd_no_child_elements"><?php _e('No conditions configured.', 'rp_wcdpd'); ?></div>
    </div>
    ...
    <?php if ($current_tab === 'product_pricing'): ?>
        ...
        <div id="rp_wcdpd_no_quantity_ranges_template">
            <div class="rp_wcdpd_no_quantity_ranges rp_wcdpd_no_child_elements"><?php _e('No quantity ranges configured.', 'rp_wcdpd'); ?></div>
        </div>
                    ...
                    <div class="rp_wcdpd_quantity_range_setting">
                        <div class="rp_wcdpd_field rp_wcdpd_field_full">
                            <?php RP_WCDPD_Form::grouped_select(array(
                                ...
                                'options'                   => RP_WCDPD_Pricing::get_pricing_methods_for_display('product_pricing_quantity'),
                                'data-rp-wcdpd-validation'  => 'required',
                            ), true); ?>
                        </div>
                    </div>
        ...
        <div id="rp_wcdpd_no_group_products_template">
            <div class="rp_wcdpd_no_group_products rp_wcdpd_no_child_elements"><?php _e('No products added to group.', 'rp_wcdpd'); ?></div>
        </div>
